export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx910cd1cd59c54fbe",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "07c0efa36c679b347f2bc817a0ceb70c",
  //模板消息id
  templateID："IavS-ZB7xS7kEVDWCX41IZX9sPSsuRlprpz-mVsWRf4"
  user:[z2787148826]
  ...
  USERS: [
    {
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "IavS-ZB7xS7kEVDWCX41IZX9sPSsuRlprpz-mVsWRf4",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "",
